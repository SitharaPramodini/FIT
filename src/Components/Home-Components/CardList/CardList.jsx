...
const CardList = () => {
  ...
  return (
    <div className={`cardcontainer pb-8 bg-black ${isLight ? "light" : ""}`}>
      <h1 className="md:text-center md:mx-40 md:pt-16 md:pb-8 px-10 pt-8 leading-10 text-xl font-medium tracking-tight text-gray-900 md:text-4xl lg:text-5xl dark:text-white">
